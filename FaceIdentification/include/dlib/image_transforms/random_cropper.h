...
namespace dlib
{
    ...
    public:
        ...
        )
        {
            ...
            const unsigned long min_object_size_absolute_rows = std::ceil(min_object_size*crop_plan.rows-0.5);
            const unsigned long min_object_size_absolute_cols = std::ceil(min_object_size*crop_plan.cols-0.5);
